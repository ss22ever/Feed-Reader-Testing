...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
		 it('Have Defined Name & not Empty', function(){
            for(i = 0; i < allFeeds.length; i++){
	...
	describe('Initial Entries', function(){
        ...
        beforeEach(function(done){
            loadFeed(0, done);
        }); // Feed loaded before testing spec
    ...
    describe('New Feed Selection', function(){
         ...
         */
        it('Feed content changes when loaded', function(){
            $nF = $('.header-title').html();
            //for newer loaded feeds
            expect($f).not.toEqual($nF);
